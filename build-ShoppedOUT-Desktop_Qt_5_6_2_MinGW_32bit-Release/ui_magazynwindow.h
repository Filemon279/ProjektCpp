...
public:
    ...
    void setupUi(QDialog *magazynWindow)
    {
        ...
        asortyment->setStyleSheet(QStringLiteral(""));
        scrollArea->setWidget(scrollAreaWidgetContents);
        pushButton = new QPushButton(asortymentBox);
        pushButton->setObjectName(QStringLiteral("pushButton"));
        pushButton->setGeometry(QRect(10, 50, 101, 23));
        szukajField = new QLineEdit(asortymentBox);
        szukajField->setObjectName(QStringLiteral("szukajField"));
        szukajField->setGeometry(QRect(580, 51, 171, 21));
        szukajField->setFocusPolicy(Qt::WheelFocus);
